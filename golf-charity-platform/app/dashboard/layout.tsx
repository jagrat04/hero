      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col justify-between hidden md:flex">
        <div>
          ...
          <nav className="p-4 space-y-1">
            ...
            <NavItem href="/dashboard/scores" icon={<Target size={20} />} label="My Scores" />
            <NavItem href="/dashboard/charity" icon={<Heart size={20} />} label="Impact" />
            <NavItem href="/dashboard/winnings" icon={<Trophy size={20} />} label="Winnings" />
          </nav>
        </div>
